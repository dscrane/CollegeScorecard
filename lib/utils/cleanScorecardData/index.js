...
exports.cleanScorecardData = cleanScorecardData;
...
function cleanScorecardData(scorecards) {
  ...
  return scorecards.map(card => {
    let schoolScorecard = {}; // Iterate over the data from each school to reformat null values to display 'undisclosed'
